    ...
    <div class="main-container">
        ...
        <form @submit.prevent="submit">
            ...
            <div class="flex justify-end items-center gap-2">
                <CancelButton/>
                <button class="p-2 rounded bg-blue-700 text-white" type="submit">
                    Editar
                </button>
            </div>
        </form>
...
export default {
    ...
    data() {
        return {
            form: {
                nome: this.$props.targetMarca.nome,
            }
        }
    },
    methods: {
        submit() {
            this.$inertia.put(route('marcas.update', this.$props.targetMarca.id), this.form);
        }
    },
    props: ["errors","targetMarca"]
}
</script>
<style>
